...
function li2(x::Float64)::Float64
    cp = (
        ( 1.0706105563309304277e+0,  1.0000000000000000000e+0),
        (-4.5353562730201404017e+0, -4.5355682121856044935e+0),
        ( 7.4819657596286408905e+0,  8.1790029773247428573e+0),
        (-6.0516124315132409155e+0, -7.4634190853767468810e+0),
        ( 2.4733515209909815443e+0,  3.6245392503925290187e+0),
        (-4.6937565143754629578e-1, -8.9936784740041174897e-1),
        ( 3.1608910440687221695e-2,  9.8554565816757007266e-2),
        (-2.4630612614645039828e-4, -3.2116618742475189569e-3)
    )
