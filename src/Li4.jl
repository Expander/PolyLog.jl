...
function li4(x::Float64)::Float64
    ...
    elseif y < 0.9
        ...
        # @todo(alex): this approximation converges badly
        cp = (
            3.1695047071339404099e-9, 0.99999992476438983766,
            -10.586358731350897174, 51.247784598059004381, -150.04145283913431167,
            296.01418887700316960, -414.87093928137190710, 424.06018572961753785,
            -319.20260743348611950, 176.30238334002368075, -70.217553035863024654,
            19.461584242168521279, -3.5156497080307477137, 0.36420450702500976898,
            -0.015770192593810356244
        )
        cq = (
            1.0000000000000000000, -10.648859569536665800,
            51.900998462488108532, -153.15773230136726228, 304.98589244568267611,
            -432.22847169591064662, 447.83283833231897844, -342.83918366401556174,
            193.50184207494831632, -79.320796936703294413, 22.891131373423426491,
            -4.3963821546524734713, 0.50632557752752990451,
            -0.027949985879369966605, 0.00034804167623849770290
        )
        p = evalpoly(y, cp)
        q = evalpoly(y, cq)
        r + s*p/q
