...
function li4(x::Float64)::Float64
    ...
    elseif y < 0.9
        cp = (
            1.4518474361056007165e-5, 9.9986025987955828952e-1,
           -2.7417104550509213752e+0, 2.6912817796778072896e+0,
           -1.0998955706389973239e+0, 1.5230091883590807570e-1
        )
        cq = (
            1.0000000000000000000e+0, -2.8047917163055233406e+0,
            2.8555908506723417143e+0, -1.2495616921657304707e+0,
            2.0612844944250627584e-1, -5.6552645596140409314e-3
        )
        p = evalpoly(y, cp)
        q = evalpoly(y, cq)
        r + s*p/q
