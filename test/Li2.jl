@testset "li2" begin
    test_cmpl_function_on_data(z -> PolyLog.li2(z), joinpath(@__DIR__, "data", "Li2.txt"), 1e-14)
    test_real_function_on_data(z -> PolyLog.li2(z), joinpath(@__DIR__, "data", "Li2.txt"), 1e-14)
