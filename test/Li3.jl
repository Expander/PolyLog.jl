@testset "li3" begin
    test_cmpl_function_on_data(z -> PolyLog.li3(z), joinpath(@__DIR__, "data", "Li3.txt"), 1e-14, 1e-14)
    test_real_function_on_data(z -> PolyLog.li3(z), joinpath(@__DIR__, "data", "Li3.txt"), 1e-14, 1e-14)
